...
/**
 * @brief This is a class in BRIDGES for representing an (m x n) grid. Each
 * position in the grid will hold a GameCell object, each of which has a
 * foreground color, background color, and a symbol.
 *
...
public class GameGrid extends Grid<GameCell> {
  ...
  *
   ...
   * Populate the grid with default game cells
     ...
     * @param color - Named Color enum argument to set the background at the
     * chosen position
     */
     ...
     *
     * @param row, col - integer indices specifying the position to modify
     * @param color - Named Color enum argument to set the foreground at the
     * chosen position
     */
     ...
     *
     * @param row, col - integer indices specifying the position to modify
     * @param color - String color argument to set the background at the chosen
     * position
     */
     ...
     *
     * @param row, col - integer indices specifying the position to modify
     * @param symbol - Integer symbol argument to set the symbol at the chosen
     * position
     */
    ...
    public void drawObject(Integer row, Integer col, NamedSymbol symbol) {
         ...
         * 1: aload_1
         * 2: aload_2
         * 3: invokevirtual bridges/base/GameGrid.get:(Ljava/lang/Integer;Ljava/lang/Integer;)Ljava/lang/Object;
         * 6: checkcast     bridges/base/GameCell
         * 9: aload_3
         * 10: invokevirtual bridges/base/GameCell.setSymbol:(Lbridges/base/NamedSymbol;)V
         * 13: return
         *  */
        // </editor-fold>
    }
    ...
    public void drawObject(Integer row, Integer col, NamedSymbol symbol, String color) {
         ...
         * 3: aload_3
         * 4: aload         4
         * 6: invokestatic  bridges/base/NamedColor.valueOf:(Ljava/lang/String;)Lbridges/base/NamedColor;
         * 9: invokevirtual bridges/base/GameGrid.drawObject:(Ljava/lang/Integer;Ljava/lang/Integer;Lbridges/base/NamedSymbol;Lbridges/base/NamedColor;)V
         * 12: return
         *  */
        // </editor-fold>
    }
    ...
    public void drawObject(Integer row, Integer col, NamedSymbol symbol, NamedColor color) {
         ...
         * 14: aload_1
         * 15: aload_2
         * 16: invokevirtual bridges/base/GameGrid.get:(Ljava/lang/Integer;Ljava/lang/Integer;)Ljava/lang/Object;
         * 19: checkcast     bridges/base/GameCell
         * 22: aload         4
         * 24: invokevirtual bridges/base/GameCell.setFGColor:(Lbridges/base/NamedColor;)V
         * 27: return
         *  */
        // </editor-fold>
    }
    ...
    /**
     * get the JSON representation of the game grid. Contains separate
     * foreground, background, and symbol arrays
     *
