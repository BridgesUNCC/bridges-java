 ...
 *  from BSTElement. K-D trees can be thought of as the spatial equivalent of
 ...
 *  include quadtrees and octrees, which subdivide into equal sized quadrants and
 *  octants at each level, respectively. <p>
 *
 ...
 *  value is set by the generic parameter, K, or using setPartition() method.  
 *	It also includes a thickness property for displaying the partitioning lines 
 *  generated by the subdivision. 
 *
 *  @sa Example tutorial using KDTreeElement at
 *      http://bridgesuncc.github.io/tutorials/KdTree.html
 *
 * @param K that is the partitioner value - this is usually a number, integer
 *          or float, given a chosen dimension of partititioning
...
public class KdTreeElement<K, E> extends BSTElement<K, E> {
	 ...
	 *	thickness can used in the visualization to draw the partitioning 
	 *	lines
	 *
