...
public class GraphBFS {
	...
	public static void main(String[] args) {
		...
		Vertex aVertex=myGraph.get(DANIEL);
			...
			aVertex.setSize(8.0);
		aVertex=myGraph.get(EMMA);
			aVertex.setColor("blue");
			aVertex.setSize(8.0);
		aVertex=myGraph.get(JENNIFER);
			aVertex.setColor("blue");
			aVertex.setSize(8.0);
		aVertex=myGraph.get(SEAN);
			aVertex.setColor("blue");
			aVertex.setSize(8.0);
		aVertex=myGraph.get(GARY);
			aVertex.setColor("blue");
			aVertex.setSize(8.0);		
		aVertex=myGraph.get(MEGAN);
			aVertex.setColor("blue");
			aVertex.setSize(8.0);
		...
		anEdge = myGraph.get(MEGAN).get(JENNIFER);
			anEdge.setColor("purple");
			anEdge.setDash(new double[]{3.0,3.0});
			anEdge.setOpacity(1.0);
			anEdge.setThickness(1.0);
		anEdge = myGraph.get(SEAN).get(EMMA);
			anEdge.setColor("purple");
			anEdge.setDash(new double[]{3.0,3.0});
			anEdge.setOpacity(1.0);
			anEdge.setThickness(1.0);
		anEdge = myGraph.get(EMMA).get(GARY);
			anEdge.setColor("purple");
			anEdge.setDash(new double[]{3.0,3.0});
			anEdge.setOpacity(1.0);
			anEdge.setThickness(1.0);
		anEdge = myGraph.get(EMMA).get(DANIEL);
			anEdge.setColor("purple");
			anEdge.setDash(new double[]{3.0,3.0});
			anEdge.setOpacity(1.0);
			anEdge.setThickness(1.0);
		anEdge = myGraph.get(JENNIFER).get(GARY);
			anEdge.setColor("purple");
			anEdge.setDash(new double[]{3.0,3.0});
			anEdge.setOpacity(1.0);
			anEdge.setThickness(1.0);	
		anEdge = myGraph.get(JENNIFER).get(SEAN);
			anEdge.setColor("purple");
			anEdge.setDash(new double[]{3.0,3.0});
			anEdge.setOpacity(1.0);
			anEdge.setThickness(1.0);
		anEdge = myGraph.get(GARY).get(SEAN);
			anEdge.setColor("purple");
			anEdge.setDash(new double[]{3.0,3.0});
			anEdge.setOpacity(1.0);
			anEdge.setThickness(1.0);
		anEdge = myGraph.get(DANIEL).get(MEGAN);
			anEdge.setColor("purple");
			anEdge.setDash(new double[]{3.0,3.0});
			anEdge.setOpacity(1.0);
			anEdge.setThickness(1.0);
